    ...
    return (
        <div className=" bg-yellow-200 py-5 ">
            ...
            <div className="max-md:space-y-10 max-lg:flex-col lg:flex justify-center py-10 gap-10 ">
                <div className="justify-start max-lg:pl-24 max-md:px-5 flex items-center gap-5">
                ...
                <div className="justify-start max-md:flex-row-reverse max-lg:pl-80 max-md:px-5 flex items-center gap-5">
                    <div className="text-white text-4xl border rounded-full p-3 bg-black">
