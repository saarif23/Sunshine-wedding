    ...
    return (
        <div>
            <div data-aos="fade-down" data-aos-delay="50"
                ...
                className="max-lg:flex-col max-lg:px-5 lg:flex bg-pink-100">
                <div data-aos="fade-right" data-aos-delay="50"
                    data-aos-duration="3000"
                    className="flex-1 text-center py-20 space-y-3">
                ...
                <div data-aos="fade-left" data-aos-delay="50"
                    data-aos-duration="3000"
                    className="flex-1 ">
                    <img className="max-h-96 w-full max-lg:rounded-md" src='https://i.ibb.co/R4LvmVv/shutterstock-379219543-min.jpg' alt="" />
                </div>
            </div>
            <div data-aos="fade-up" data-aos-delay="50"
                data-aos-duration="3000"
                className="max-lg:flex-col max-lg:px-5 lg:flex lg:flex-row-reverse bg-lime-100">
                ...
                <div className="flex-1 ">
                    <img className="max-h-96 w-full max-lg:rounded-md" src='https://i.ibb.co/Ns4DfzL/shutterstock-476920312-min.jpg' alt="" />
                </div>
            </div>
        </div>
    );
